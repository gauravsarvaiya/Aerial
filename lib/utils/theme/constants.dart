...
const Color kPrimaryColor = Color(0xffFFA800);
const Color kTextPrimaryColor = Color(0xff686263);
const Color kSecondaryColor = Color(0xff20202C);
...
const Color kTextFiledBorderColor = Color(0xFF464660);
const Color kTextFiledTextColor = Colors.white38;
